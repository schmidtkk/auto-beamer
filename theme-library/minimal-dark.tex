...
% ═════════════════════════════════════════════════════════════════════════════
%  COLOR PALETTE — Dark Mode (Catppuccin-inspired)
% ═════════════════════════════════════════════════════════════════════════════
\definecolor{Navy}{HTML}{5b6078}
\definecolor{NavyDark}{HTML}{1e2030}
\definecolor{NavyLight}{HTML}{363a4f}
\definecolor{NavyTint}{HTML}{24273a}
\definecolor{Brick}{HTML}{8aadf4}
\definecolor{BrickLight}{HTML}{1e2030}
\definecolor{Ink}{HTML}{cad3f5}
\definecolor{InkSoft}{HTML}{a5adcb}
\definecolor{Surface}{HTML}{1e2030}
...
\setbeamercolor{block body alerted}{bg=Surface}
\setbeamercolor{block title example}{bg=NavyLight,fg=NavyDark}
\setbeamercolor{block body example}{bg=Surface}
