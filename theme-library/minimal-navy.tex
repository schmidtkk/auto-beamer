...
% ═════════════════════════════════════════════════════════════════════════════
%  COLOR PALETTE — Teal + Deep Orange
% ═════════════════════════════════════════════════════════════════════════════
\definecolor{Navy}{HTML}{00796b}
\definecolor{NavyDark}{HTML}{004d40}
\definecolor{NavyLight}{HTML}{b2dfdb}
\definecolor{NavyTint}{HTML}{e0f2f1}
\definecolor{Brick}{HTML}{e65100}
\definecolor{BrickLight}{HTML}{fbe9e7}
\definecolor{Ink}{HTML}{1b2631}
\definecolor{InkSoft}{HTML}{34495e}
\definecolor{Surface}{HTML}{f1f8f7}
